...
minTemp = 30                 # Temperature and speed range variables, edit these to adjust max and min temperatures and speeds
maxTemp = 85
minSpeed = 0
maxSpeed = 110
...
print(f"[INFO] CPU Temp: {cpu_temp}°C → Fan PWM: {fan_speed}%")
